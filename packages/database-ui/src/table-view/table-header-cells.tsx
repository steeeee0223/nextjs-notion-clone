    ...
    >
      <div className="relative flex">
        <div
          ...
          style={{ width }}
        >
          <Hint description={property.name} side="right" className="z-[990]">
            <div
              role="button"
              tabIndex={0}
              className={cn(
                "flex h-full w-full animate-bg-in cursor-pointer select-none items-center px-2 hover:bg-primary/5",
              ...
              <div className="flex min-w-0 flex-auto items-center text-sm/[1.2]">
                ...
                {property.description && (
                  <div className="inline-flex items-center">
                    <Icon.Info className="ml-1 mt-px block h-full w-3.5 shrink-0 fill-primary/35" />
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="absolute right-0 z-10 w-0 grow-0">
          <div
            tabIndex={-1}
            className={cn(
              "-ml-[3px] -mt-[1px] h-[34px] w-[5px] animate-bg-out cursor-col-resize bg-blue/0 hover:bg-blue/80",
  ...
  ({ icon, onClick }, ref) => {
    return (
      <div
        ...
        className="flex w-8 cursor-pointer select-none justify-start opacity-100 transition-opacity duration-200 hover:bg-primary/5 focus-visible:outline-none"
        onClick={onClick}
        onKeyDown={onClick}
      >
